...
export class DeepSeekProvider implements ILLMProvider {
    ...
    private buildPrompt(params: GenerateSectionParams): string {
        ...
        const sectionLabelMap: Record<typeof sectionType, string> = {
            summary: 'a concise 3–4 line professional summary focusing on this role',
            skills: 'a bullet list of 8–12 technical skills mapped to this job description',
            experience: 'a bullet list (5–8 bullets) highlighting relevant experience, quantified where possible',
            coverLetter: '2–3 paragraphs of a tailored cover letter body (no greeting or signature)',
        };
        ...
        prompt += `\n\nReturn only plain text (no markdown formatting, no latex preamble) suitable to be embedded.`;
